...
public class Locators 
{
	...
	public static class NPW_EasyPlus
	{
		
		public static String persondropdown(String Menu)
		{
			if(Menu.equalsIgnoreCase("My parents or in-laws"))
			{
			sXpath="//div[@class ='icon-MyParentsOrInlaws']";
			return sXpath;
			}
			else if(Menu.equalsIgnoreCase("Me and My Direct Family"))
			{
				sXpath="//div[@class ='icon-MeAndMyImmediateFamily']";
				return sXpath;
			}
			else if(Menu.equalsIgnoreCase("My extended family"))
			{
				sXpath="//div[@class ='icon-MyExtendedFamily']";
				return sXpath;
			}
			else
			{
				Messages.errorMsg="xpath not found";
				return "";
			}
		}
		
		public static String persondropdownitem(String SubMenu)
		{
			sXpath="//ul[@class ='chosen-results']/li[text()='"+SubMenu+"']";
			return sXpath;
		}
		...
		public static String VerifyRates()
		{
			sXpath="//span[@class='total-value-wrap ng-binding']";
			return sXpath;
		}
