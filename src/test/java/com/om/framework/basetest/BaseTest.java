...
public class BaseTest extends TestListenerAdapter
{
	...
	public static String sChromeExtension="C:\\Users\\XY58778\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\Extensions\\0.1.7_0";
	...
	public static void launchBrowser(@Optional("ff") String inputBrowser,
		...
		try {
			...
			if(sBrowser.equalsIgnoreCase("IE"))
				...
				driver = Browser.openChromeBrowserWithXtension(sTestSiteURL, sChromeDriverPath, "Drivers\\extension_0_1_7_0.crx");
